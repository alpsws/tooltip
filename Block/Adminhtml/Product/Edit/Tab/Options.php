 ...
 *
 * @author     Alps Team <core@magentocommerce.com>
 */

namespace Alps\Tooltip\Block\Adminhtml\Product\Edit\Tab;
...
class Options extends Widget
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addChild('options_box', 'Alps\Tooltip\Block\Adminhtml\Product\Edit\Tab\Options\Option');
