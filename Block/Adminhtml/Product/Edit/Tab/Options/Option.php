 ...
 */
namespace Alps\Tooltip\Block\Adminhtml\Product\Edit\Tab\Options;
...
class Option extends Widget
{
    ...
    public function getCustomOptionDescription()
    {
        
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $model = $objectManager->create('Alps\Tooltip\Model\ResourceModel\AlpsTooltip\Collection');
        $model->addFieldToFilter('product_id',array('eq' => $this->getCurrentProductId()));

        foreach ($model as $value) 
        {
            $result[$value['option_id']] = $value['product_tooltip_description'];
        }
